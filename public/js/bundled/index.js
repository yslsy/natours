...
},{"@babel/polyfill":"dTCHC","./login":"7yHem","./updateSettings":"l3cGY","./stripe":"10tSC","./signup":"fNY2o"}],"dTCHC":[function(require,module,exports) {
"use strict";
...
const logout = async ()=>{
    try {
        ...
        (0, _alerts.showAlert)("error", "Error logging out! Try again.s");
    }
};
...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alerts = require("./alerts");
const stripe = Stripe("pk_test_51NLHQNFN2DQGtdeLBHRebQGpG4JNw9noLVwgQHDEl8IhJmIgTziguvHaDrEaxbE5ooOmWvdYuKvhNFzKftYOyctD00ftVVTOcN");
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./alerts":"6Mcnf"}],"fNY2o":[function(require,module,exports) {
/* eslint-disable */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
